    ...
    <section class="container mx-auto p-4 mt-4">
      ...
      <div class="flex space-x-4 ml-4">
        <a href="/jobs/<?=$jobDetails["id"]?>/edit" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Edit</a>
        <button 
          onclick="deleteJob(<?= $jobDetails['id'] ?>)" 
        ...
        <div class="p-4">
          ...
          <ul class="my-4 bg-gray-100 p-4">
            <li class="mb-2"><strong>Salary:</strong><?=$jobDetails["salary"]?></li>
            <li class="mb-2">
              <strong>Location:</strong> <?$jobDetails["city"]?>
              <span
            ...
            <li class="mb-2">
              <?= isset($job['tags']) ? '<strong>Tags:</strong> <span>' . $job['tags'] . '</span>' : '' ?>
            </li>
          </ul>
        </div>
      </div>
